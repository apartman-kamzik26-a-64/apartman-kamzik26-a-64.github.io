...
test("guest request uses the v4 canonical Kamzik contract", () => {
  for (const value of [
    "action:'guest_request'", "schema_version:'4'", "property_code:''",
    "property_options:'KAMZIK26,KAMZIK64'",
    "const INVOICE_SOURCE_SITE='apartman-kamzik26-a-64.github.io'",
    "guest_name:", "address:", "company_id:", "tax_id:", "vat_id:",
    "guest_email:", "booking_id:", "note:", "email_confirmed:",
